...
Darkroom.plugins['color'] = Darkroom.Plugin.extend({
    ...
    onMouseUp: function(event) {
        ...
        this.destroy();
        this.darkroom.options.color = color.rgb;
    },
    ...
    updateButtonColor: function(color) {
        if (this.colorPickerButton !== null && this.colorPickerButton.element.firstElementChild !== null) {
            this.colorPickerButton.element.firstElementChild.style.fill = color;
        }
    },
